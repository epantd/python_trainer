    ...
    try {
        ...
        setTimeout(() => {
            try {
                ...
                fetch('https://script.google.com/macros/s/AKfycbwoeaDu_a66NQB-1XZELlMf0wexMo1n9YywCbOQPVVdOpS-z8o8uSYE0iqdAO3JlRas/exec', {
                    method: 'POST',
                    mode: 'no-cors',
                    headers: {
...
function updateTaskSidebar(taskText, levelId) {
    let partTitle = "";
    if (currentPart === 1) partTitle = "Урок 1: Переменные, типы данных, операции присваивания и вывода";
    else if (currentPart === 2) partTitle = "Урок 2: input() и Движение";
    else if (currentPart === 3) partTitle = "Урок 3: Ввод и вывод данных";
...
function showIntroScreen() {
    ...
    if (currentPart === 1) {
        lessonSubtitle.textContent = 'Урок 1. Переменные, типы данных, операции присваивания и вывода';
        ...
        lessonSubtitle.textContent = 'Урок 2. Оператор input() и Управление почтальоном';
        lessonText.innerHTML = `
        ...
        lessonSubtitle.textContent = 'Урок 3. Ввод и вывод данных';
        lessonText.innerHTML = `
...
window.nextLevel = async function() {
    ...
    if (currentLevel + 1 < currentLevelList.length) {
        ...
        if (currentPart > 3) {
            ...
            winModal.querySelector('#modal-text').innerHTML = `Поздравляем, ты настоящий кодер! Ты прошел все уроки!<br><br>🎖️ <strong>Общий опыт: ${totalExperience}</strong>`;
...
const REFERENCE_DATA = {
    ...
    2: {
        title: "Справка: Урок 2 - Ввод и движение",
        content: `
            <h3>📥 Ввод данных</h3>
