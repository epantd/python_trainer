...
const PART_2_LEVELS = [
    ...
    { 
        ...
        requiredValue: 5, 
        description: "Собери знания от всех шести артефактов: возьми основу от <b>Камня Истоков</b>, добавь мудрость от трёх <b>Духов Просветления</b>, усиль результат <b>Артефактом Усиления</b> и найди магический остаток для <b>Сверх-Каналов</b>. Передай финальный магический остаток <b>Великому Кристаллу</b>.", 
